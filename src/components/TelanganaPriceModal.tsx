      ...
      <div className="relative w-full max-w-4xl bg-white border border-neutral-200 rounded-3xl shadow-2xl overflow-hidden z-10 my-auto flex flex-col max-h-[92vh]">
        ...
        <div className="sticky top-0 z-20 flex items-center justify-between px-6 py-4 bg-neutral-50/90 border-b border-neutral-200 backdrop-blur-md">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 id="price-modal-title" className="text-base sm:text-lg font-bold text-neutral-900 leading-tight">
        ...
        <div className="overflow-y-auto p-5 sm:p-6 space-y-5">
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-neutral-50 border border-neutral-200 grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
            <div className="md:col-span-6 flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-extrabold text-neutral-900">{model.name}</h3>
          ...
          <div className="p-4 rounded-2xl bg-neutral-100 border border-neutral-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-neutral-600">
                  100% Exemption on Road Tax &amp; Registration Fees. Upfront savings: <strong className="text-neutral-900 font-mono">{formatINR(breakdown.totalUpfrontSavings || 0)}</strong>
                </p>
              </div>
            </div>
            <button
              onClick={() => setIsPolicyInfoOpen(!isPolicyInfoOpen)}
              className="text-xs font-bold text-neutral-800 hover:text-neutral-950 flex items-center gap-1 shrink-0 cursor-pointer"
            >
          ...
          {isPolicyInfoOpen && (
            <div className="p-4 rounded-2xl bg-neutral-50 border border-neutral-200 text-xs space-y-2 text-neutral-600">
              <p className="font-semibold text-neutral-900">Official Government Order Summary (G.O. Ms No. 41):</p>
          ...
          <div className="rounded-2xl border border-neutral-200 overflow-hidden bg-white">
            <div className="bg-neutral-50 px-5 py-3 border-b border-neutral-200 flex items-center justify-between">
              <span className="text-xs font-bold text-neutral-800 uppercase tracking-wider">Itemized Breakdown</span>
              <span className="text-xs font-bold text-neutral-500 font-mono">{currentRto.rtoCode}</span>
            </div>
            ...
            <div className="divide-y divide-neutral-100 text-xs">
              ...
              <div className="px-5 py-3 flex items-center justify-between">
                <div>
                  <span className="font-bold text-neutral-900">1. Ex-Showroom Price (MSRP)</span>
                  <span className="text-[11px] text-neutral-500 block">Manufacturer invoice including GST</span>
                </div>
                <span className="font-mono font-bold text-neutral-900 text-sm">{formatINR(breakdown.exShowroom)}</span>
              </div>

              {/* PM E-DRIVE Subsidy */}
              {breakdown.pmEdriveSubsidy > 0 && (
                <div className="px-5 py-3 flex items-center justify-between bg-neutral-50/50">
                  <div>
                    <span className="font-bold text-neutral-900">2. Central PM E-DRIVE Subsidy</span>
                    <span className="text-[11px] text-neutral-500 block">Central Government direct manufacturer incentive</span>
                  </div>
                  <span className="font-mono font-bold text-neutral-900 text-sm">-{formatINR(breakdown.pmEdriveSubsidy)}</span>
                </div>
              )}

              {/* Road Tax Line */}
              <div className="px-5 py-3 flex items-center justify-between bg-neutral-50">
                <div>
                ...
                <div className="text-right">
                  <span className="font-mono font-extrabold text-neutral-900 text-sm block">₹0</span>
                  <span className="text-[10px] text-neutral-600 font-bold bg-neutral-200 px-1.5 py-0.2 rounded">100% EXEMPT</span>
                </div>
              </div>
              ...
              <div className="px-5 py-3 flex items-center justify-between bg-neutral-50">
                <div>
                  <span className="font-bold text-neutral-900">4. RTO Registration &amp; Smart Card Fee</span>
                  <span className="text-[11px] text-neutral-500 block">Standard Petrol Fee: <del>₹785</del></span>
                </div>
                <div className="text-right">
                  <span className="font-mono font-extrabold text-neutral-900 text-sm block">₹0</span>
                  <span className="text-[10px] text-neutral-600 font-bold bg-neutral-200 px-1.5 py-0.2 rounded">WAIVED</span>
                </div>
              </div>
              ...
              <div className="px-5 py-3 flex items-center justify-between">
                <div>
                  <span className="font-bold text-neutral-900">5. Laser-Etched HSRP Number Plate</span>
                  <span className="text-[11px] text-neutral-500 block">Statutory fitment at RTO authorized center</span>
                </div>
                <span className="font-mono font-bold text-neutral-900 text-sm">₹{breakdown.hsrpPlateFee || 400}</span>
              </div>
              ...
              <div className="px-5 py-3">
                <div className="flex items-center justify-between">
                  <div>
                    <span className="font-bold text-neutral-900">6. Mandatory 5-Year Insurance</span>
                    <span className="text-[11px] text-neutral-500 block">1-Year Own Damage (OD) + 5-Year Third Party (TP)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="font-mono font-bold text-neutral-900 text-sm">{formatINR(breakdown.insurance5Year)}</span>
                    <button
                ...
                {isInsuranceExpanded && (
                  <div className="mt-2 pt-2 border-t border-neutral-100 grid grid-cols-2 gap-2 text-[11px] text-neutral-600 bg-neutral-50 p-2.5 rounded-xl">
                    <div>1-Yr Own Damage: <strong className="font-mono text-neutral-900">{formatINR(insuranceDetails.od1Year)}</strong></div>
                    <div>5-Yr Third Party: <strong className="font-mono text-neutral-900">{formatINR(insuranceDetails.tp5Year)}</strong></div>
                    <div>Personal Accident Cover: <strong className="font-mono text-neutral-900">{formatINR(insuranceDetails.cpaCover)}</strong></div>
                    <div>GST on Insurance (18%): <strong className="font-mono text-neutral-900">{formatINR(insuranceDetails.gst18)}</strong></div>
                  </div>
                )}
              </div>
              ...
              <div className="px-5 py-3 flex items-center justify-between">
                <div>
                  <span className="font-bold text-neutral-900">7. Home Charging Unit &amp; Cable</span>
                  <span className="text-[11px] text-neutral-500 block">
              ...
              {/* Total On-Road Price */}
              <div className="px-5 py-4 flex items-center justify-between bg-neutral-900 text-white rounded-b-2xl">
                <div>
        ...
        <div className="p-4 sm:px-6 border-t border-neutral-200 bg-neutral-50/90 flex flex-wrap items-center justify-between gap-3">
          ...
          <button
            onClick={handleCopyQuote}
            className="flex items-center gap-1.5 px-5 py-2 rounded-full bg-neutral-900 hover:bg-neutral-800 text-white text-xs font-bold transition cursor-pointer shadow-xs"
          >
