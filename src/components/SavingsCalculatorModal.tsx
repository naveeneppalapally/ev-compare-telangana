...
Generated by EV Compare Telangana (2026)`;
  ...
  return (
    <div 
      className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-neutral-900/60 backdrop-blur-md animate-fade-in overflow-y-auto"
      onClick={handleClose}
      role="dialog"
      aria-modal="true"
    ...
    >
      <div 
        className="relative w-full max-w-4xl bg-white border border-neutral-200 rounded-3xl shadow-2xl overflow-hidden my-auto max-h-[92vh] flex flex-col text-neutral-900"
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-neutral-200 bg-neutral-50/80">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 id="savings-modal-title" className="text-base sm:text-lg font-bold text-neutral-900 tracking-tight">
                  Petrol vs EV Financial &amp; ROI Engine
                </h2>
                <span className="inline-flex items-center gap-1 rounded-full bg-neutral-200 px-2.5 py-0.5 text-[10px] font-bold text-neutral-800">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-neutral-100 hover:bg-neutral-200 text-neutral-700 border border-neutral-300 text-xs font-semibold transition cursor-pointer"
            >
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-2xl bg-neutral-50 border border-neutral-200">
              ...
              <select
                ...
                className="w-full py-2 px-3 bg-white border border-neutral-300 rounded-xl text-xs font-bold text-neutral-900 focus:outline-none focus:ring-2 focus:ring-neutral-900/10 cursor-pointer"
              >
                {evModels.map((m) => (
              ...
              <div className="mt-2.5 flex items-center justify-between text-xs pt-2 border-t border-neutral-200">
                <span className="text-neutral-500">Telangana Net On-Road ({rtoCode}):</span>
            ...
            <div className="p-4 rounded-2xl bg-neutral-50 border border-neutral-200">
              <div className="flex items-center justify-between mb-1.5">
                ...
                <span className="text-[10px] font-semibold text-neutral-600 bg-neutral-200 px-2 py-0.5 rounded-md">
                  12% TG Road Tax
                </span>
              </div>
              ...
              <div className="mt-2.5 flex items-center justify-between text-xs pt-2 border-t border-neutral-200">
                <span className="text-neutral-500">Petrol Price in Hyderabad:</span>
          ...
          <div className="p-3.5 rounded-2xl bg-neutral-900 text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-sm">
            <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-4 text-xs font-mono shrink-0">
              <div className="text-left sm:text-right">
                <span className="text-[10px] text-neutral-400 uppercase block">EV Output</span>
                <span className="font-bold text-white">{evBhp} bhp • {evTorque} Nm</span>
              </div>
              <div className="text-left sm:text-right border-l border-neutral-700 pl-3">
                <span className="text-[10px] text-neutral-400 uppercase block">Petrol Output</span>
                <span className="font-bold text-neutral-300">{benchmark.petrolBhp} bhp • {benchmark.petrolTorqueNm} Nm</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
            <div className="p-4 rounded-2xl bg-neutral-50 border border-neutral-200">
              ...
              <div className="space-y-1 my-1.5">
                <div className="flex justify-between text-xs">
                  <span className="text-neutral-500">Petrol ({benchmark.modelName.split(' ')[0]}):</span>
                  <span className="font-mono font-bold text-neutral-800">
                    ₹{(savingsResult.petrolFuelCostPerKm || (petrolPrice / petrolMileage)).toFixed(2)}/km
                  </span>
                </div>
                <div className="flex justify-between text-xs">
                  <span className="text-neutral-500">EV ({activeModel.brand}):</span>
                  <span className="font-mono font-bold text-neutral-900">
              ...
              <div className="pt-2 border-t border-neutral-200 flex justify-between items-center text-xs">
                <span className="text-neutral-600 font-semibold">Monthly Saving:</span>
                <span className="font-mono font-bold text-neutral-900">
            ...
            <div className="p-4 rounded-2xl bg-neutral-50 border border-neutral-200">
              ...
              <div className="text-2xl font-black text-neutral-900 font-mono tracking-tight my-1">
                {formatINR(savingsResult.monthlySavings)}<span className="text-xs font-normal text-neutral-500"> / mo</span>
              </div>
              <p className="text-[11px] text-neutral-600">
                {formatINR(savingsResult.annualSavings)} saved every year on fuel
              </p>
              <div className="pt-2 border-t border-neutral-200 flex justify-between items-center text-xs">
                <span className="text-neutral-600 font-semibold">5-Yr Operational:</span>
                <span className="font-mono font-bold text-neutral-900">
            ...
            <div className="p-4 rounded-2xl bg-neutral-50 border border-neutral-200">
              ...
              <div className="pt-2 border-t border-neutral-200 flex justify-between items-center text-xs">
                <span className="text-neutral-600 font-semibold">Annual Net Benefit:</span>
                <span className="font-mono font-bold text-neutral-900">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
              <div>
                <div className="flex justify-between mb-1">
                  <span className="text-neutral-600">Daily Commute:</span>
                  <span className="font-mono font-bold text-neutral-900">{dailyKm} km / day</span>
                </div>
                <input
                  type="range"
                  min="10"
              ...
              <div>
                <div className="flex justify-between mb-1">
                  <span className="text-neutral-600">Petrol Mileage:</span>
                  <span className="font-mono font-bold text-neutral-900">{petrolMileage} km / L</span>
                </div>
                <input
                  type="range"
                  min="25"
              ...
              <div>
                <div className="flex justify-between mb-1">
                  <span className="text-neutral-600">TSSPDCL Rate:</span>
                  <span className="font-mono font-bold text-neutral-900">₹{electricityRate.toFixed(2)} / kWh</span>
                </div>
                <input
                  type="range"
                  min="4.5"
          ...
          <div className="p-5 rounded-2xl bg-neutral-50 border border-neutral-200 space-y-3">
            ...
            <div>
              <div className="flex justify-between text-xs mb-1">
                <span className="text-neutral-600 font-semibold">{benchmark.modelName} (Petrol):</span>
                <span className="font-mono font-bold text-neutral-900">
                  {formatINR(petrolTCO)}
                </span>
              </div>
            ...
            <div className="pt-2">
              <div className="flex justify-between text-xs mb-1">
                <span className="text-neutral-600 font-semibold">{activeModel.brand} {activeModel.name} (EV):</span>
                <span className="font-mono font-bold text-neutral-900">
                  {formatINR(evTCO)}
                </span>
              </div>
        ...
        {/* Footer */}
        <div className="p-4 sm:px-6 border-t border-neutral-200 bg-neutral-50/80 flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            <button
