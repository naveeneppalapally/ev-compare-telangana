...
Generated by EV Compare Telangana (2026)`;
  ...
  return (
    <div 
      className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4 bg-stone-900/60 backdrop-blur-md animate-fade-in overflow-y-auto pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] sm:pt-4 sm:pb-4"
      onClick={handleClose}
      role="dialog"
      aria-modal="true"
    ...
    >
      <div 
        className="relative w-full max-w-4xl bg-white border border-stone-200 rounded-3xl shadow-2xl overflow-hidden my-auto max-h-[100dvh] sm:max-h-[92vh] flex flex-col text-stone-900"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center justify-between gap-2 px-4 sm:px-6 py-3 sm:py-4 border-b border-stone-200 bg-stone-50/80 flex-wrap sm:flex-nowrap">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2 flex-wrap">
                <h2 id="savings-modal-title" className="text-base sm:text-lg font-bold text-stone-900 tracking-tight truncate">
                  Petrol vs EV Financial &amp; ROI Engine
                </h2>
                <span className="inline-flex items-center gap-1 rounded-full bg-stone-200 px-2.5 py-0.5 text-[10px] font-bold text-stone-800 shrink-0">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 px-3 py-2.5 min-h-[44px] rounded-full bg-stone-100 hover:bg-stone-200 text-stone-700 border border-stone-300 text-xs font-semibold transition cursor-pointer"
            >
        ...
        <div className="p-4 sm:px-6 border-t border-stone-200 bg-stone-50/80 flex flex-wrap items-center justify-between gap-3">
          ...
          <button
            onClick={handleCopySummary}
            className="flex items-center gap-1.5 px-5 py-2.5 min-h-[44px] rounded-full bg-stone-900 hover:bg-stone-800 text-white text-xs font-bold transition cursor-pointer shadow-xs"
          >
