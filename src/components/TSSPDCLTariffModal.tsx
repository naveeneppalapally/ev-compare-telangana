          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 id="tariff-modal-title" className="text-base sm:text-lg font-bold text-neutral-900 leading-tight">
        ...
        <div className="overflow-y-auto p-5 sm:p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-2xl bg-neutral-50 border border-neutral-200">
              ...
              <div className="text-2xl font-black font-mono text-neutral-900">
                {evUnitsConsumed} <span className="text-xs font-normal text-neutral-500">Units (kWh) / mo</span>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div>
                <div className="flex justify-between mb-1">
                  <span className="text-neutral-600">Current Monthly Household Units:</span>
                  <span className="font-mono font-bold text-neutral-900">{householdUnits} Units</span>
                </div>
                <input
                  type="range"
                  min="50"
                ...
                <span className="text-[10px] text-neutral-500 block mt-1">
                  Current Electricity Bill: <strong className="text-neutral-900 font-mono">{formatINR(baseHouseholdBill)}</strong>
                </span>
              </div>

              <div>
                <div className="flex justify-between mb-1">
                  <span className="text-neutral-600">Monthly EV Riding Distance:</span>
                  <span className="font-mono font-bold text-neutral-900">{monthlyKm} km / month</span>
                </div>
                <input
                  type="range"
                  min="300"
                ...
                />
                <span className="text-[10px] text-neutral-500 block mt-1">
                  Daily average: <strong className="text-neutral-900 font-mono">{Math.round(monthlyKm / 30)} km / day</strong>
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200 overflow-hidden bg-white">
            <div className="bg-neutral-50 px-5 py-3 border-b border-neutral-200 flex items-center justify-between">
              ...
              <span className="text-xs font-mono font-bold text-neutral-500">Telangana Electricity Regulatory Commission</span>
            </div>
            ...
            <table className="w-full text-left text-xs border-collapse">
              ...
              <tbody className="divide-y divide-neutral-100 text-xs font-medium text-neutral-700">
                <tr>
                  <td className="p-3 font-bold text-neutral-900">0 – 100 Units</td>
                  <td className="p-3">LT-I (A) Lifeline</td>
                  <td className="p-3 font-mono font-bold text-neutral-900">₹1.95 – ₹3.10</td>
                  <td className="p-3 text-neutral-600">Lowest rate per km (~₹0.10/km)</td>
                </tr>
                <tr>
                  <td className="p-3 font-bold text-neutral-900">101 – 200 Units</td>
                  <td className="p-3">LT-I (B) Middle Class</td>
                  <td className="p-3 font-mono font-bold text-neutral-900">₹3.40 – ₹4.80</td>
                  <td className="p-3 text-neutral-600">Standard domestic rate (~₹0.18/km)</td>
                </tr>
                <tr>
                  <td className="p-3 font-bold text-neutral-900">201 – 300 Units</td>
                  <td className="p-3">LT-I (C) High Usage</td>
                  <td className="p-3 font-mono font-bold text-neutral-900">₹7.70</td>
                  <td className="p-3 text-neutral-600">Standard urban slab (~₹0.26/km)</td>
                </tr>
                <tr>
                  <td className="p-3 font-bold text-neutral-900">301 – 400 Units</td>
                  <td className="p-3">LT-I (C) Peak Domestic</td>
                  <td className="p-3 font-mono font-bold text-neutral-900">₹9.00</td>
                  <td className="p-3 text-neutral-600">Higher slab rate (~₹0.31/km)</td>
                </tr>
              </tbody>
            </table>
          </div>
