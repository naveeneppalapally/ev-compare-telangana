        ...
        <div className="overflow-y-auto p-5 sm:p-6 space-y-5">
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-stone-50 border border-stone-200 grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
            <div className="md:col-span-6 flex items-center gap-3">
              ...
              <div>
                <span className="text-[10px] font-bold uppercase tracking-wider text-stone-500">{currentEV.brand}</span>
                <h3 className="text-lg sm:text-xl font-extrabold text-stone-900">{currentEV.name}</h3>
          ...
          <div className="p-6 rounded-2xl bg-stone-900 text-white shadow-md flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              ...
              <div className="flex items-baseline gap-2 mt-1">
                ...
                <span className="text-lg font-bold text-stone-400">km / full charge</span>
              </div>
            ...
            <div className="p-3.5 rounded-xl bg-stone-800 border border-stone-700 max-w-xs text-xs">
              <div className="flex items-center gap-1.5 font-bold mb-1 text-stone-200">
                {isCommutePossible ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 text-xs">
            <div className="p-4 rounded-2xl bg-stone-50 border border-stone-200">
              <label className="font-bold text-stone-700 block mb-2">1. Riding Mode</label>
            ...
            <div className="p-4 rounded-2xl bg-stone-50 border border-stone-200">
              <label className="font-bold text-stone-700 block mb-2">2. Passenger Payload</label>
              <div className="grid grid-cols-2 gap-1.5">
                {[
            ...
            <div className="p-4 rounded-2xl bg-stone-50 border border-stone-200">
              <label className="font-bold text-stone-700 block mb-2">3. Climate / Temperature</label>
              <div className="grid grid-cols-2 gap-1.5">
                {[
            ...
            <div className="p-4 rounded-2xl bg-stone-50 border border-stone-200">
              <label className="font-bold text-stone-700 block mb-2">4. Traffic Condition</label>
              <div className="grid grid-cols-2 gap-1.5">
                {[
            ...
            <div className="p-4 rounded-2xl bg-stone-50 border border-stone-200">
              <label className="font-bold text-stone-700 block mb-2">5. Route Terrain</label>
              <div className="grid grid-cols-2 gap-1.5">
                {[
            ...
            <div className="p-4 rounded-2xl bg-stone-50 border border-stone-200">
              <div className="flex justify-between mb-2">
                <label className="font-bold text-stone-700">6. Daily Commute Target</label>
                <span className="font-mono font-bold text-stone-900">{commuteDistanceKm} km</span>
              </div>
              <input
                type="range"
                min="10"
