    ...
    >
      ...
      <div className="relative w-full max-w-4xl bg-white border border-stone-200 rounded-3xl shadow-2xl overflow-hidden z-10 my-auto flex flex-col max-h-[92vh]">
        ...
        <div className="overflow-y-auto p-5 sm:p-6 space-y-5">
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-stone-50 border border-stone-200 grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
            <div>
            ...
            <div>
              <div className="flex justify-between mb-1 text-xs">
                <span className="text-stone-600 font-semibold">Ex-Showroom Invoice Price:</span>
                <span className="font-mono font-bold text-stone-900">{formatINR(vehicleCost)}</span>
              </div>
              <input
                type="range"
                min="40000"
          ...
          <div className="p-5 rounded-2xl bg-stone-900 text-white shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
            ...
            <div className="p-3 rounded-xl bg-stone-800 border border-stone-700 text-xs max-w-xs">
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="bg-stone-50 text-[11px] font-bold text-stone-500 uppercase border-b border-stone-200">
                  ...
                  <th className="p-3.5 bg-stone-100 font-extrabold text-stone-900">⚡ Electric Two-Wheeler</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-stone-100 text-xs font-medium text-stone-700">
                <tr>
                  <td className="p-3.5 font-semibold text-stone-900">
                    ...
                    <span className="text-[10px] text-stone-500 font-normal">Applicable on invoice value</span>
                  </td>
                  <td className="p-3.5 font-mono text-stone-800">
                    {formatINR(petrolLifeTax)} ({petrolTaxPercent}%)
                  </td>
                  <td className="p-3.5 bg-stone-50/50 font-mono font-bold text-stone-900">
                    ₹0 <span className="text-[10px] bg-stone-200 px-1.5 py-0.2 rounded ml-1 font-sans">100% EXEMPT</span>
                  </td>
                </tr>
                ...
                <tr>
                  <td className="p-3.5 font-semibold text-stone-900">
                    ...
                    <span className="text-[10px] text-stone-500 font-normal">Registration ₹300 + Card ₹285 + Postal ₹200</span>
                  </td>
                  <td className="p-3.5 font-mono text-stone-800">
                    {formatINR(petrolRegistrationFees)}
                  </td>
                  <td className="p-3.5 bg-stone-50/50 font-mono font-bold text-stone-900">
                    ₹0 <span className="text-[10px] bg-stone-200 px-1.5 py-0.2 rounded ml-1 font-sans">WAIVED</span>
                  </td>
                </tr>
                ...
                <tr>
                  <td className="p-3.5 font-semibold text-stone-900">
                    ...
                    <span className="text-[10px] text-stone-500 font-normal">Statutory physical plate fitment</span>
                  </td>
                  <td className="p-3.5 font-mono text-stone-800">
                    ₹{hsrpFee}
                  </td>
                ...
                <tr className="bg-stone-50 font-bold">
                  <td className="p-3.5 text-stone-900 uppercase">
                    Total Government RTO Fees
                  </td>
                  <td className="p-3.5 font-mono text-stone-900 text-sm">
                    {formatINR(petrolTotalRtoCharge)}
                  </td>
                  <td className="p-3.5 font-mono text-stone-900 text-sm bg-stone-100">
                    ₹{evTotalRtoCharge}
                  </td>
                </tr>
              </tbody>
